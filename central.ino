...
void controlHaptic(BLEDevice peripheral) {

  peripheral.connect();
  peripheral.discoverAttributes();

  BLECharacteristic hapticTalkCharacteristic = peripheral.characteristic("19b10001-e8f2-537e-4f6c-d104768a1214");
